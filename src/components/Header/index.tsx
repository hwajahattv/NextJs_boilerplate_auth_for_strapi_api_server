              ...
              <div className="flex items-center justify-end pr-16 lg:pr-0">
                {isAuthenticated ? (
                  <button
                    ...
                    className="ease-in-up rounded-xs bg-red-500 px-8 py-3 text-base font-medium text-white transition duration-300 hover:bg-red-600 md:block md:px-9 lg:px-6 xl:px-9"
                  >
                    Logout
                  </button>
                ) : (
